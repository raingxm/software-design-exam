...
### 4.2 抛弃型试点 vs 当产品交付（英语完形）

> 错题：2026-08-18 · [practice 日志](../../practice/README.md)

Brooks《人月神话》：Plan to throw one away; you will, anyhow.

| 题干信号 | 选 | 别选 |
|----------|----|------|
| plan in advance to build a ( )，后文 deliver the throwaway | **throwaway** | product / system / software |
| 管理层要不要做试点系统 | 不是问题（**必做必扔**） | 真正问的是交不交给客户 |
| 用完丢掉，再瀑布正式开发 | **抛弃型原型** | 演化型（原型长成产品） |

口令：**第一个东西要不要交给客户**；计划做的是 throwaway。
...
试点必做必扔；问的是交不交给客户（throwaway ≠ product）
