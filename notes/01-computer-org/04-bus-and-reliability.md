...
#### 3. 混合系统
将复杂系统拆解为串联和并联的组合，分层计算：备份组先并联成一个数，再拿去串联。

> 巩固过关（2026-08-19）：三块 0.5 并联 → 0.875；0.9 串联 + 两块 0.8 并联 → 0.864。若并联结果比单个还低，公式套反了。详见 [37](../deep-dives/37-reliability-tutorial.md)。
