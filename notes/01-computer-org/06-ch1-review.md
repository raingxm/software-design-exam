...
> 巩固：[35 补码+流水线](../deep-dives/35-complement-pipeline-tutorial.md) · 海明 [02](../deep-dives/02-hamming-code-tutorial.md)  
> 来源：2026-08-18 按错题回炉（不按教材目录）
...
| 3 | 并联可靠度 | 🔄 公式已讲，题未答 | [总线与可靠度](./04-bus-and-reliability.md) |
| 4 | Cache 容量/映射、32 位寻址 | ⬜ | [存储系统](./03-storage-systems.md) |
| 5 | 旋转延迟取半圈 | ⬜ | 同上 |
...
刀 3 待答：三个相同部件并联，单个可靠度 0.5。系统可靠度？先写「全坏」再写「1−全坏」。
